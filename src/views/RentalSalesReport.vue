...
// Auth store for current user attribution
...
async function downloadReport() {
  ...
  try {
    ...
    // Add footer with generation time and user attribution
    ctx.fillStyle = '#6b7280'
    ctx.font = '10px sans-serif'
    ctx.textAlign = 'center'
    ctx.fillText(`Generated by: ${generatedBy.value}`, width / 2, height - 40)
